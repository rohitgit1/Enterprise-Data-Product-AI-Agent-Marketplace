...
"""MCP server for DP-HLT-003 — Workforce & Care Capacity.
...
server = ProductServer(
    ...
    certified_kpis=['KPI-OTSHARE-098', 'KPI-AGENCY-099', 'KPI-OCCUP-100', 'KPI-HPPD-101', 'KPI-BOARD-102'],
    sliceable_columns=['facility', 'unit_type', 'shift'],
    supported_grains=['day', 'week', 'month'],
    row_limit=24800,
)


@server.tool("query_unit_operations")
def query_unit_operations(request: ToolRequest) -> ToolResponse:
