...
"""MCP server for DP-RTL-003 — Visit & Conversion Funnel.
...
server = ProductServer(
    ...
    certified_kpis=['KPI-CONVRATE-048', 'KPI-ABANDON-076', 'KPI-VISITDWELL-077'],
    sliceable_columns=['channel', 'store_format', 'entry_category', 'device_class', 'traffic_source'],
    supported_grains=['day', 'week', 'month'],
    row_limit=31200,
)


@server.tool("query_visit_customer")
def query_visit_customer(request: ToolRequest) -> ToolResponse:
