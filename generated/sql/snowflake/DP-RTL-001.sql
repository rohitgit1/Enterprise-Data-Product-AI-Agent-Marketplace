...
ALTER TABLE DP_RTL_001.T_DP_RTL_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_NOT_NULL ON (transaction_id);

-- QR-RTL-001-02: freshness / partition_completion_by (severity critical)
ALTER TABLE DP_RTL_001.T_DP_RTL_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_PARTITION_COMPLETION_BY ON (*);

-- QR-RTL-001-03: validity / in_reference_set (severity high)
ALTER TABLE DP_RTL_001.T_DP_RTL_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_IN_REFERENCE_SET ON (category);

-- QR-RTL-001-04: uniqueness / unique_at_grain (severity critical)
ALTER TABLE DP_RTL_001.T_DP_RTL_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_UNIQUE_AT_GRAIN ON (transaction_id, sku);

-- QR-RTL-001-05: accuracy / reconcile_to_finance_ledger (severity critical)
ALTER TABLE DP_RTL_001.T_DP_RTL_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_RECONCILE_TO_FINANCE_LEDGER ON (net_sales);
