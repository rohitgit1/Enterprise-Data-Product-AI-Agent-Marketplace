...
SELECT
  meter_id,  -- MASK_PII unavailable on this platform; grant by column instead
  interval_start,
  rate_class,
  region,
  feeder,
...
-- SELECT 'QR-ENG-001-01' AS rule_id, ... FROM DP_ENG_001.T_DP_ENG_001;

-- QR-ENG-001-02: freshness / partition_completion_by (severity high)
-- SELECT 'QR-ENG-001-02' AS rule_id, ... FROM DP_ENG_001.T_DP_ENG_001;

-- QR-ENG-001-03: validity / in_reference_set (severity high)
-- SELECT 'QR-ENG-001-03' AS rule_id, ... FROM DP_ENG_001.T_DP_ENG_001;

-- QR-ENG-001-04: uniqueness / unique_at_grain (severity critical)
-- SELECT 'QR-ENG-001-04' AS rule_id, ... FROM DP_ENG_001.T_DP_ENG_001;

-- QR-ENG-001-05: consistency / estimated_implies_null_interval (severity medium)
-- SELECT 'QR-ENG-001-05' AS rule_id, ... FROM DP_ENG_001.T_DP_ENG_001;
