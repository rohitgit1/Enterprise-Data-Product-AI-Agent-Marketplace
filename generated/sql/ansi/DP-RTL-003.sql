...
-- SELECT 'QR-RTL-003-01' AS rule_id, ... FROM DP_RTL_003.T_DP_RTL_003;

-- QR-RTL-003-02: uniqueness / unique_at_grain (severity critical)
-- SELECT 'QR-RTL-003-02' AS rule_id, ... FROM DP_RTL_003.T_DP_RTL_003;

-- QR-RTL-003-03: freshness / partition_completion_by (severity critical)
-- SELECT 'QR-RTL-003-03' AS rule_id, ... FROM DP_RTL_003.T_DP_RTL_003;

-- QR-RTL-003-04: validity / in_reference_set (severity high)
-- SELECT 'QR-RTL-003-04' AS rule_id, ... FROM DP_RTL_003.T_DP_RTL_003;

-- QR-RTL-003-05: consistency / non_negative (severity high)
-- SELECT 'QR-RTL-003-05' AS rule_id, ... FROM DP_RTL_003.T_DP_RTL_003;
